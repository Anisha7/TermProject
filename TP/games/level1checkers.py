...
class Checkers(PygameGame):
    ...
    def draw(self, surface):
        self.surf = pygame.draw.rect(surface, (125,125,125), [0, 0, 950, 600]) # background surface
        ...
        for row in range(len(self.board)):
            for col in range(len(self.board[row])):
                ...
                # draw board
                left = (self.squareSize * col) + self.margin/2
                #print("left: ", left)
                ...
                pygame.draw.rect(surface, (125,125,125), [left, top, right, bottom], 2)
